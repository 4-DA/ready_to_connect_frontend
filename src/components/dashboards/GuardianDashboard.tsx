// components/dashboards/GuardianDashboard.tsx
"use client";
...
export default function GuardianDashboard() {
      ...
      >
        ...
        <div className="z-10 relative">
          <div className="text-sm font-medium">
            {user.full_name || "Unknown Guardian"}
          </div>
          <p className={`text-xs text-${primaryColor}-200`}>Guardian</p>
        </div>
      </div>
    );
  };
  ...
  const ChildProgress = () => {
    return (
      ...
      >
        ...
        ></div>
        <div className="z-10 relative">
          <h2 className="text-lg font-semibold mb-4">Child's Progress</h2>
  ...
  return (
    <div className="flex min-h-screen bg-[#0e0e13] text-white relative">
      ...
      <Sidebar userType={user?.user_type?.toLowerCase() || "guardian"} />
